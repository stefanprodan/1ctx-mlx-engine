...
| What | Value |
|---|---|
| Version | mlx-serve 26.9.5-pre-release.1 (MLX 0.32.2), installed from the Engine page on 2026-09-20 after the cut-over to the new name, binary `~/.1ctx-mlx-engine/engine/versions/v26.9.5-pre-release.1/mlx-serve`. Upgrades, rollbacks and flag changes happen on the Engine page (`http://$STUDIO_HOST:11235/engine`), with `include pre-releases` on |
...
2026-09-07). It is also what to enter on the Engine page after a wipe:
